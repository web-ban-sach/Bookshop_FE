...
export const Footer = () => {
    ...
    return (
        <footer className="text-gray-500 bg-white py-5 mt-10 md:px-8 shadow-inner shadow-gray-400">
            <div className="gap-6 justify-between px-[120px] md:flex">
                <div className="flex-1">
                    <div className="max-w-xs">
                        <img src="https://res.cloudinary.com/dyewrrq39/image/upload/v1699954671/bookshop/gxwg1z51r02g4fiybngr.png" className="w-32" />
            ...
            <div className="mt-8 px-[100px] py-6 border-t items-center justify-between sm:flex">
